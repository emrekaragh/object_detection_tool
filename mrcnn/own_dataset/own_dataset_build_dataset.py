...
import own_dataset_build_dataset_config as config
...
def build(args):
    ...
    ap.add_argument("--num_classes", default=config.NUM_CLASSES_CSV,
    ...
    for (dType, imagePaths, outputCSV) in dataset:
        ...
        for imagePath in imagePaths:
            ...
            # fname = "{}".format(fname[:fname.rfind(".")])
    ...
    num_classes.write( str(len(rows)) )
    num_classes.close()
